...
export class InvoicesDashboardComponent implements OnInit {
  ...
  public chartDatasets: Array<any> = [
    { data: [65, 59, 80, 81, 56, 55, 40, 59, 80, 81, 56, 55, 40], label: 'My First dataset' }
  ];

  public chartLabels: Array<any> = ['Red', 'Blue', 'Yellow', 'Green', 'Purple', 'Orange', 'Blue', 'Yellow', 'Green', 'Purple', 'Orange'];
