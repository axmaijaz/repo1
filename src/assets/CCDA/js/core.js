...
$(document).ready(function(){
	...
	$('#twocXmlSelect').on('change', function(){
    var fileSelected;
		$('#viewcda').html('')
    ...
    var reader = new FileReader();
        ...
        reader.onloadend = function(e){
            ...
            const patientFirst = $(xmlDoc).find( "patient" ).find('given').text();
            const patientLast = $(xmlDoc).find( "patient" ).find('family').text();
            new Transformation().setXml(reader.result).setXslt('cda.xsl').transform("viewcda");
        };
